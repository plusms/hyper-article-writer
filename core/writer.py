...
⑦ H4タグが使われていないか
⑦' 「〜することで、〜ができるようになる」構文が使われていないか（「〜すると」「〜により」に置き換える）
⑦'' ""（ダブルクォーテーション）が本文中で使われていないか
⑦''' `<!-- H2_BLOCK_START:... -->` `<!-- クリニック紹介ブロック入る -->` 以外のHTMLコメントが出力されていないか
